...
Each row represents one completed taxi trip. Location is reported at three nested levels, census tract within community area, plus a centroid coordinate pair. The 23 fields group as follows, with the full field-by-field dictionary given in @tbl-fielddict. For demand modeling, only the pickup-side time and location fields are required.
