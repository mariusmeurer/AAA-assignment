...
Beyond this, two limitations remain. The raw records contain recording artefacts, most visibly trips of zero distance or zero duration, which we quantify and address in the next section. More fundamentally, the dataset captures **served demand** only: requests that went unmet leave no trace, so the data understate true demand in exactly those places and periods where supply was scarce.